...
begin
    ...
    -- ==========================================
    -- CONVERSIONE GLOBALE -> LOCALE E HIT TEST
    -- ==========================================
    ...
    -- Traduzione della Y in coordinata locale interna alla Tile (0 - 23)
    ...
    -- Offset per il Double Buffering (solo su VRAM, non su ZBUF)
    ...
    -- ==============================================
    -- MACCHINA A STATI DEL CLEAR/SWAP
    -- ==============================================
    ...
    -- ==============================================
    -- GESTIONE MEMORIE (INFERENZA BRAM)
    -- ==============================================
    ...
    begin
        if rst = '1' then
            ...
            -- Il pixel ̬ valido se lo era in origine E se cade nella nostra Tile
