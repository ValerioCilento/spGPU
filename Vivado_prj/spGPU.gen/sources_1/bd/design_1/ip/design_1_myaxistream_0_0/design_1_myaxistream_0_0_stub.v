...
//               c:/Users/lucaf/Desktop/spGPU/spGPU.gen/sources_1/bd/design_1/ip/design_1_myaxistream_0_0/design_1_myaxistream_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_myaxistream_0_0,myaxistream_v1_0,{}" *) (* core_generation_info = "design_1_myaxistream_0_0,myaxistream_v1_0,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=myaxistream,x_ipVersion=1.0,x_ipCoreRevision=8,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,C_S_AXIS_TDATA_WIDTH=64}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "myaxistream_v1_0,Vivado 2024.2" *) 
module design_1_myaxistream_0_0(ready_enb, instr_valid, data_1_o, data_2_o, 
  s_axis_aclk, s_axis_aresetn, s_axis_tready, s_axis_tdata, s_axis_tvalid)
/* synthesis syn_black_box black_box_pad_pin="ready_enb,instr_valid,data_1_o[31:0],data_2_o[31:0],s_axis_aresetn,s_axis_tready,s_axis_tdata[63:0],s_axis_tvalid" */
