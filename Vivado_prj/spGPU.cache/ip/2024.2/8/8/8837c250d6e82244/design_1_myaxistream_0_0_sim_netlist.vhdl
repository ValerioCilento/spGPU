...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myaxistream_v1_0_S_AXIS is
  signal \FSM_sequential_state_t[0]_i_1_n_0\ : STD_LOGIC;
  signal \FSM_sequential_state_t[1]_i_1_n_0\ : STD_LOGIC;
...
begin
\FSM_sequential_state_t[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"15100000"
    )
        port map (
...
\FSM_sequential_state_t[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0800"
    )
        port map (
...
begin
  ...
  data_1_o(31 downto 0) <= \^s_axis_tdata\(31 downto 0);
  data_2_o(31 downto 0) <= \^s_axis_tdata\(63 downto 32);
