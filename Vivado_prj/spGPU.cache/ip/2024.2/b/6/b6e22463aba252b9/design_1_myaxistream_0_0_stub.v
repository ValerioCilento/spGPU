...
(* CHECK_LICENSE_TYPE = "design_1_myaxistream_0_0,myaxistream_v1_0,{}" *) (* core_generation_info = "design_1_myaxistream_0_0,myaxistream_v1_0,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=myaxistream,x_ipVersion=1.0,x_ipCoreRevision=8,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXIS_TDATA_WIDTH=64}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "myaxistream_v1_0,Vivado 2024.2" *) 
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ready_enb, instr_valid, data_1_o, data_2_o, 
