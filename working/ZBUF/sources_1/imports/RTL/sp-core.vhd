...
Port(
	...
	pixel_z                 : out std_logic_vector(N_zdepth-1 downto 0);
...
architecture STRUCTURAL of spCORE is 
	...
	component spEXEC is
		...
		port(
		    ...
		    z_in                    : in std_logic_vector(N_zdepth-1 downto 0);
	        z_out                   : out std_logic_vector(N_zdepth-1 downto 0);
			pixel_valid_o           : out std_logic;
			fb_swap 				: out std_logic;
			pixel_x_o               : out std_logic_vector(N_pixel-1 downto 0);
			pixel_y_o               : out std_logic_vector(N_pixel-1 downto 0);
	...
	signal z_wire : std_logic_vector(N_zdepth-1 downto 0);
begin
